  ...
  return (
    <div className="space-y-4 pt-4">
      {lessonFields.map((lesson, lessonIndex) => (
        <div
          key={lesson.id}
          className="p-4 border rounded-md space-y-3 bg-background relative"
        >
          <Button
            type="button"
            variant="ghost"
              ...
              <FormItem className="flex-grow">
                <FormControl>
                  <Input
                    ...
                    {...field}
                    className="text-lg font-semibold border-0 bg-transparent p-0 focus-visible:ring-0 focus-visible:ring-offset-0"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-2xl font-headline flex items-center gap-2">
                    <BookText /> Create New Course
                  </CardTitle>
                  <CardDescription>
                    Manually create a new course by filling in all the required
                    details below.
                  </CardDescription>
                </CardHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Detailed description for main page."
                            className="min-h-32"
                            {...field}
                          />
                        </FormControl>
