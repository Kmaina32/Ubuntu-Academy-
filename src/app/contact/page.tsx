                    ...
                    <div className="flex items-start gap-4">
                     ...
                     <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">For support or inquiries, email us at <a href="mailto:info@mandanetwork.co.ke" className="text-primary underline">info@mandanetwork.co.ke</a>.</p>
                        </div>
                    </div>
                     <div className="flex items-start gap-4">
                         <div className="bg-primary/10 p-2 rounded-md mt-1">
