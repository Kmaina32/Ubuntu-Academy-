...
import { Info, Loader2, Users, Target, BookOpen } from "lucide-react";
      ...
      <main className="flex-grow flex items-center justify-center p-4 bg-secondary">
        <Card className="w-full max-w-2xl text-center">
          <CardHeader>
            ...
            <CardTitle className="text-3xl font-headline">About Mkenya Skilled</CardTitle>
