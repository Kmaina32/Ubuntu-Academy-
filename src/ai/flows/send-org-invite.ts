...
const sendOrganizationInviteFlow = ai.defineFlow(
  ...
  async ({ email, organizationId, organizationName }) => {
    ...
    try {
      ...
      const emailSubject = `You're invited to join ${organizationName} on Edgewood International A.I College`;
      const emailBody = `
        <p>Hello,</p>
        <p>You have been invited to join the <strong>${organizationName}</strong> team on the Edgewood International A.I College learning platform.</p>
        ...
        <p>Thanks,<br>The Edgewood International A.I College Team</p>
      `;
