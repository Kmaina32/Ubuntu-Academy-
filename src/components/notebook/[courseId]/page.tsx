...
export default function NotebookPage() {
  ...
  const handleDownload = async () => {
    ...
    pdf.save(`Akili_AI_Academy_Notes_${course.title.replace(/\s+/g, '_')}.pdf`);
        ...
        <div ref={pdfRef} className="p-10 bg-white w-[595px] text-black">
            <div className="border-b-2 border-black pb-4 mb-4 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-xl font-headline">Akili AI Academy</span>
                </div>
            ...
            <div className="bg-gray-50 p-4 rounded-md border min-h-[600px]">
                ...
                &copy; {new Date().getFullYear()} Akili AI Academy. All rights reserved.
            </p>
        </div>
    </div>
   </>
