...
export function Certificate({ course }: CertificateProps) {
  ...
  return (
    <div className="font-sans">
        ...
        <div className="max-w-4xl mx-auto bg-white border-8 border-primary p-10 shadow-2xl relative aspect-[1.414/1] print:shadow-none print:border-4">
            <div className="absolute inset-0 border-2 border-accent m-3 print:border-1"></div>
            <div className="relative z-10 flex flex-col h-full text-center">

                <div className="mb-8 print:mb-4">
                    <p className="text-xl text-muted-foreground uppercase tracking-widest print:text-base">Certificate of Completion</p>
                </div>

                <div className="flex-grow flex flex-col justify-center">
                    <p className="text-lg text-foreground mb-2 print:text-sm">This certificate is proudly presented to</p>
                    <h1 className="text-7xl font-signature text-primary my-4 print:text-5xl print:my-2">{user.name}</h1>
                    <p className="text-lg text-foreground mt-2 print:text-sm">
                        for successfully completing the online course
                    </p>
                    <h2 className="text-4xl font-bold text-foreground mt-4 font-headline print:text-2xl print:mt-2">
                        {course.title}
                    </h2>
                </div>
                ...
                <div className="flex justify-between items-end text-sm print:text-xs">
                    <div className="text-center w-1/3">
                        <p className="font-signature text-3xl text-gray-800 print:text-2xl">{course.instructor}</p>
                    ...
                    <div className="text-center w-1/3">
                         <p className="font-signature text-3xl text-gray-800 print:text-2xl">A. Omolo</p>
                        <hr className="border-gray-400 mt-1 mx-auto w-3/4"/>
