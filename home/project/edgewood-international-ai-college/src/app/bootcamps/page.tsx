...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Tech Bootcamps in Kenya | Manda Network';
  const description = 'Join our intensive tech bootcamps. Gain job-ready skills in web development, data science, and more. Enroll today and accelerate your career in tech.';
            ...
            <div className="container mx-auto px-4 md:px-6">
               <div className="relative rounded-xl overflow-hidden min-h-[400px] flex items-center justify-center text-center p-4">
                    ...
                    <div className="relative z-10 text-white">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold font-headline">Tech Bootcamps</h1>
