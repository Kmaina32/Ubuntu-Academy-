...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Tech Hackathons & Coding Competitions | Manda Network';
  const description = 'Join exciting tech hackathons in Kenya. Compete, build innovative projects, and win prizes. Open to all levels.';
